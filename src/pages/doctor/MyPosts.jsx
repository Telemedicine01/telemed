...
const mockArticles = [
  {
    id: 1,
    title: 'Understanding Women\'s Reproductive Health',
    status: 'published',
    category: 'obgyn',
    createdAt: '2023-05-15T10:30:00Z',
    views: 1245,
    likes: 89,
    excerpt: 'Comprehensive guide to maintaining reproductive health through different life stages.'
  },
  {
    id: 2,
    title: 'Pregnancy Nutrition: What You Need to Know',
    status: 'published',
    category: 'obgyn',
    createdAt: '2023-06-22T14:15:00Z',
    views: 876,
    likes: 45,
    excerpt: 'Essential nutrition guidelines for expectant mothers and fetal development.'
  },
  {
    id: 3,
    ...
    views: 1532,
    likes: 112,
    excerpt: 'Effective strategies for managing menopause symptoms without medication.'
  }
];
...
const categoryStyles = {
  obgyn: 'bg-pink-100 text-pink-800'
};
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Women's health resources</p>
            </div>
          </div>
          <Link
            to="/doctor/articles/new"
        ...
        <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-5">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search OBGYN articles..."
        ...
        {filteredArticles.length > 0 ? (
          ...
          <div className="bg-white rounded-xl shadow-xs border border-gray-100 overflow-hidden">
            <div className="text-center py-16 px-4">
              ...
              <p className="mt-1 text-gray-500 max-w-md mx-auto">
                {searchTerm ? "Try a different search term" : "Create your first article"}
              </p>
              <div className="mt-6">
                <Link
                  to="/doctor/articles/new"
