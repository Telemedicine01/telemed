...
import docphone from "../../assets/images/docphone.jpeg";
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h5 className="text-emerald-200 font-medium mb-2">
                Love Hospital Virtual Care
              </h5>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Extend Your Practice Beyond Hospital Walls
              </h1>
              <p className="text-xl mb-8 text-emerald-100 max-w-lg">
                Join our hospital's elite team of physicians providing
                world-class care through our secure telehealth platform.
              </p>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h5 className="text-emerald-600 font-medium mb-2">
              FOR OUR PHYSICIANS
            </h5>
            <h2 className="text-3xl font-bold mb-4">
              Why Join Our Telehealth Network
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Love Hospital provides our physicians with cutting-edge technology
              to deliver exceptional care remotely.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all border-t-4 border-emerald-500">
              ...
              <p className="text-gray-600">
                Leverage Love Hospital's reputation while reaching patients who
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all border-t-4 border-emerald-500">
              ...
              <p className="text-gray-600">
                Supplement your hospital hours with flexible telehealth sessions
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all border-t-4 border-emerald-500">
              ...
              <p className="text-gray-600">
                Generate supplemental income through our competitive
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all border-t-4 border-emerald-500">
              ...
              <p className="text-gray-600">
                Our hospital-grade secure platform meets all compliance
                requirements and protects sensitive data.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all border-t-4 border-emerald-500">
              ...
              <p className="text-gray-600">
                Fully integrated with Love Hospital's EMR system for smooth
                patient management.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all border-t-4 border-emerald-500">
              ...
              <p className="text-gray-600">
                Full technical, administrative, and clinical support from Love
                Hospital's staff.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="md:flex md:items-center md:gap-16">
            ...
            <div className="md:w-1/2">
              <h5 className="text-emerald-600 font-medium mb-3">
                ABOUT Love HOSPITAL
              </h5>
              ...
              <p className="text-gray-700 mb-6">
                For over 50 years, Love Hospital has been at the forefront of
                medical innovation and patient care. Our state-of-the-art
                facilities and world-class medical team ensure that patients
                receive the highest quality of care available.
              </p>
              <p className="text-gray-700 mb-8">
                Our telehealth initiative extends our exceptional care beyond
                physical boundaries, allowing our talented physicians to reach
                more patients while maintaining the same standards of
                excellence.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center relative">
              ...
              <p className="text-gray-600">
                Complete our simple application process for Memorial Hospital
                physicians.
              </p>
            </div>
            ...
            <div className="text-center relative">
              ...
              <p className="text-gray-600">
                Complete platform training and telehealth best practices
                certification.
              </p>
            </div>
            ...
            <div className="text-center relative">
              ...
              <p className="text-gray-600">
                Define your availability and integrate with your hospital
                schedule.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Begin seeing patients through our secure hospital telehealth
                platform.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Meet some of our leading doctors who are pioneering telehealth at
              Memorial Hospital
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-50 relative overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from Memorial Hospital physicians about their telehealth
              experiences
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm relative">
              ...
              <p className="text-gray-700 mb-6 pt-4">
                "As the Chief of Cardiology, I was skeptical about telehealth,
                but our hospital's platform has allowed me to monitor
                post-operative patients more effectively and reduce readmission
                rates."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm relative">
              ...
              <p className="text-gray-700 mb-6 pt-4">
                "The integration with our hospital EMR system makes telehealth
                consultations seamless. I can provide the same quality of
                psychiatric care while balancing my hospital rounds."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                  <img
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm relative">
              ...
              <p className="text-gray-700 mb-6 pt-4">
                "Memorial's telehealth platform allows me to provide follow-up
                care to surgical patients without them needing to travel. The
                secure image sharing feature is particularly valuable."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full overflow-hidden mr-4">
                  <img
        ...
        <div className="max-w-6xl mx-auto">
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-1/2 mb-12 md:mb-0 pr-0 md:pr-12">
              ...
              <p className="text-gray-700 mb-6">
                Our telehealth platform was designed specifically for Memorial
                Hospital's high standards of patient care and security.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ultra-high definition video for detailed patient
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Seamless connection with Memorial Hospital's electronic
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Track patient outcomes and practice metrics with our
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-teal-700 to-emerald-900 text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl mb-8 text-emerald-100 max-w-2xl mx-auto">
            Join Memorial Hospital's elite telehealth physician network and help
            us redefine healthcare delivery.
          </p>
